...
<div class="card">
    <form action="index.  class="btn">Back to Warehouses</a>
</div>

<div class="card">
    <form action="index.php?route=warehouses&action=store" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea id="address" name="address" rows="3" required><?= $_SESSION['form_data']['address'] ?? '' ?></textarea>
